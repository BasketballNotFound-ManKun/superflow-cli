...
description: Use when an OpenSpec/SDD change has passed verification and needs explicit archive confirmation, lifecycle closeout, archived state recording, or recovery from archive.
---
