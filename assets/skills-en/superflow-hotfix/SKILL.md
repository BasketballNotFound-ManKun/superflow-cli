...
description: Use when a small bug fix or urgent behavior repair may use a lighter workflow unless API, database, cross-repo, status, SQL, SDK, or real-entry gates are involved.
---
