...
description: Use when a tiny non-behavioral change such as wording, prompts, docs, config comments, or local process text may use a lighter workflow unless runtime gates are involved.
---
